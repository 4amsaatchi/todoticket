...
<script id="tmpl-theme-preview" type="text/template">
	<div class="wp-full-overlay-sidebar">
		<div class="wp-full-overlay-header">
			...
			<button class="previous-theme"><span class="screen-reader-text"><?php _e( 'Anterior' ); ?></span></button>
			<button class="next-theme"><span class="screen-reader-text"><?php _e( 'Siguiente' ); ?></span></button>
			<# if ( data.installed ) { #>
