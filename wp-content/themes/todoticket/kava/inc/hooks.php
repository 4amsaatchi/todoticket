...
function kava_modify_comment_form( $args ) {
	...
	$args['label_submit'] = esc_html__( 'Enviar Comentario', 'kava' );
	...
	$args['comment_field'] = '<p class="comment-form-comment"><textarea id="comment" class="comment-form__field" name="comment" placeholder="' . esc_attr__( 'Comentarios *', 'kava' ) . '" cols="45" rows="7" aria-required="true" required="required"></textarea></p>';
