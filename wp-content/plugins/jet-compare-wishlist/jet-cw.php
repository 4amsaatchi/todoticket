 ...
 * Plugin URI:  https://crocoblock.com/woocommerce/compare-wishlist/
	...
	class Jet_CW {
		...
		public function init() {
			...
			if ( is_admin() ) {
				...
				require $this->plugin_path( 'includes/updater/class-jet-cw-plugin-changelog.php' );

				jet_cw_plugin_changelog()->init( array(
					'name'        => 'JetCompareWishlist For Elementor',
					'slug'        => 'jet-cw',
					'plugin_file' => 'jet-compare-wishlist/jet-cw.php',
					'version'     => $this->get_version(),
					'author'      => '<a href="https://zemez.io/zemezjet/">Zemez</a>',
					'homepage'    => 'https://crocoblock.com/woocommerce/compare-wishlist/',
					'banners'     => array(
