...
class WC_Product_Variable extends WC_Product {
	...
	*/
	...
	public function add_to_cart_text() {
		return apply_filters( 'woocommerce_product_add_to_cart_text', $this->is_purchasable() ? __( 'Ver más', 'woocommerce' ) : __( 'Ver más', 'woocommerce' ), $this );
	}
	...
	public function add_to_cart_description() {
		...
		return apply_filters( 'woocommerce_product_add_to_cart_description', sprintf( __( 'Ver más', 'woocommerce' ), $this->get_name() ), $this );
	}
